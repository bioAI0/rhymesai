...
get0.json: generate0.json
	python catception_get_video2.py generate0.json | tee get0.json
...
get1.json: generate1.json
	python catception_get_video2.py generate1.json | tee get1.json
...
get2.json: generate2.json
	python catception_get_video2.py generate2.json | tee get2.json
...
get3.json: generate3.json
	python catception_get_video2.py generate3.json | tee get3.json
...
get4.json: generate4.json
	python catception_get_video2.py generate4.json | tee get4.json
...
get5.json: generate5.json
	python catception_get_video2.py generate5.json | tee get5.json
...
get6.json: generate6.json
	python catception_get_video2.py generate6.json | tee get6.json
...
get7.json: generate7.json
	python catception_get_video2.py generate7.json | tee get7.json
...
get8.json: generate8.json
	python catception_get_video2.py generate8.json | tee get8.json
...
get9.json: generate9.json
	python catception_get_video2.py generate9.json | tee get9.json
